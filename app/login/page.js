    ...
    <div className="page-shell mx-auto grid max-w-6xl gap-8 px-5 py-12 sm:px-8 lg:grid-cols-[0.85fr_1fr] lg:items-center lg:py-16">
      ...
      <section className="tech-card rounded-lg p-6 sm:p-8">
        ...
        <div className="mt-6 flex flex-col gap-3">
          <a href="/api/v1/user/auth/google" className="btn-secondary w-full flex items-center justify-center gap-2">
          ...
          <a href="/api/v1/user/auth/github" className="btn-secondary w-full flex items-center justify-center gap-2">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
