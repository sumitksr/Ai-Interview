  ...
  try {
    ...
    const html = `
      <div style="font-family:sans-serif;max-width:600px;margin:auto;background:#0a0f1c;padding:32px;border-radius:16px;border:1px solid #263246;color:#cbd6e4;">
        ...
        <p>Your mentor will reach out to confirm the meeting link. Prepare your questions and give it your best!</p>
  ...
  try {
    ...
    const html = `
      <div style="font-family:sans-serif;max-width:600px;margin:auto;background:#0a0f1c;padding:32px;border-radius:16px;border:1px solid #263246;color:#cbd6e4;">
        ...
        <p>Please reach out to the student to share the meeting link and confirm the session.</p>
